...
It comes prepopulated with **57 instrument models / ~6,400 documented commands** (HP/Agilent,
...
data/instruments/*.json            bundled instrument command database (57 models)
